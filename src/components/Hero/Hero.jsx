...
const ImageList = [
    {
        ...
        description : 
        "lorem His Life will forever be Changed dolor sit amet, consectetur adipiscing elit, ed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
    },
    {
        id : 2,
        img : Image2,
                    ...
                    <div key={data.id}>
                        <div className="grid grid-cols-1 sm:grid-cols-2">
                            ...
                            <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1">
                                ...
                                <p data-aos="zoom-out" data-aos-duration="500" data-aos-once="true" className="text-sm">{data.description}</p>
                                <div>
                            ...
                            <div className="order-1 sm:order-2">
                                <div className="relative z-10 overflow-hidden">
                                    <img src={data.img} alt="" className="w-[300px] h-[300px] sm:h-[450px] sm:w-[450px] sm:scale-105 object-contain mx-auto" />
                                </div>
                            </div>
                        </div>
                    </div>
