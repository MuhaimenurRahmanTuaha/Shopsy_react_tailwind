...
const ProductsData = [
    {
        ...
        title: "Casual Wear",
        description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, quia. Quibusdam accusamus nobis repudiandae reiciendis consectetur natus blanditiis ut."
    },
    {
        id: 2,
        img: Img2,
                    ...
                    <div key={data.id} data-aos="zoom-in" className="rounded-2xl bg-white dark:bg-gray-800 hover:bg-black/80 dark:hover:bg-primary hover:text-white relative shadow-xl duration-300 group max-w-[300px]">
                        ...
                        <div className="p-4 text-center">
                            ...
                            <div className="w-full flex items-center justify-center gap-1">
                                <FaStar className="text-yellow-500 dark:group-hover:text-white transition duration-300" />
                                <FaStar className="text-yellow-500 dark:group-hover:text-white transition duration-300" />
                                <FaStar className="text-yellow-500 dark:group-hover:text-white transition duration-300" />
                                <FaStar className="text-yellow-500 dark:group-hover:text-white transition duration-300" />
                            </div>
