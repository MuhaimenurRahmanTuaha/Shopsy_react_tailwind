...
import Banner from "../../assets/website/footerBanner.jpg";
        ...
        <div data-aos="zoom-in" className="container">
            <div className="grid md:grid-cols-3 pb-44 pt-5">
                ...
                <div className="py-8 px-4">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed adipisci harum totam, iusto veniam autem.</p>
                </div>
                {/* Footer Links */}
